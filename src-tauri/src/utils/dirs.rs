...
pub static APP_ID: &str = "io.github.AkarinServer.rv-verge";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "rv-verge-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.AkarinServer.rv-verge.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "rv-verge-backup-dev";
...
pub fn service_path() -> Result<PathBuf> {
    ...
    Ok(res_dir.join("rv-verge-service"))
}

#[cfg(windows)]
pub fn service_path() -> Result<PathBuf> {
    let res_dir = app_resources_dir()?;
    Ok(res_dir.join("rv-verge-service.exe"))
}
