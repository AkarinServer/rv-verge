...
async fn uninstall_service() -> Result<()> {
    ...
    let uninstall_path = binary_path.with_file_name("rv-verge-service-uninstall.exe");
...
async fn install_service() -> Result<()> {
    ...
    let binary_path = dirs::service_path()?;
    let install_path = binary_path.with_file_name("rv-verge-service-install.exe");
...
async fn uninstall_service() -> Result<()> {
    ...
    let uninstall_path =
        tauri::utils::platform::current_exe()?.with_file_name("rv-verge-service-uninstall");
...
async fn install_service() -> Result<()> {
    ...
    let install_path =
        tauri::utils::platform::current_exe()?.with_file_name("rv-verge-service-install");
...
async fn uninstall_service() -> Result<()> {
    ...
    let binary_path = dirs::service_path()?;
    let uninstall_path = binary_path.with_file_name("rv-verge-service-uninstall");
...
async fn install_service() -> Result<()> {
    ...
    let binary_path = dirs::service_path()?;
    let install_path = binary_path.with_file_name("rv-verge-service-install");
